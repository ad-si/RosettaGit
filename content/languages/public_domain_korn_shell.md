...
The last version, [pdksh 5.2.14](http://web.cs.mun.ca/~michael/pdksh/) from 1999 July 13, still has several bugs. Systems like [Debian](http://packages.debian.org/sid/pdksh), [OpenBSD](https://www.openbsd.org/cgi-bin/cvsweb/src/bin/ksh/) and [PLD](http://cvs.pld-linux.org/cgi-bin/cvsweb.cgi/packages/pdksh/) now apply several patches to pdksh.
