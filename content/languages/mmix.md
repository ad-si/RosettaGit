...
## Playing with MMIX
In order to work with MMIX you'll have to download and install [MMIXware](http://www-cs-faculty.stanford.edu/~knuth/programs/mmix-20090321.tar.gz) . This provides you with a simple simulator, assembler, test programs, and full documentation, plus the meta-simulator.
...
Visit also [Knuth's MMIX News](http://www-cs-faculty.stanford.edu/~knuth/mmix-news.html)
