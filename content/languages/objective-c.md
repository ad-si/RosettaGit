...
For details of how to compile and run examples of Rosetta Code tasks written in Objective C under Linux or Windows see [GNUstep](https://www.gnu.org/software/gnustep/)
<br clear=right>
