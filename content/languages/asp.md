...
'''Active Server Pages''', usually abbreviated as '''ASP''', is a scripting engine for web servers. Although developed by [Microsoft](https://rosettacode.org/wiki/Microsoft), and used almost exclusively under [IIS](https://en.wikipedia.org/wiki/Internet_Information_Services), there are a few third-party implementations, most notably [Apache::ASP](http://www.apache-asp.org/) (and, before the Oracle buyout, Sun's Chilisoft ASP).
