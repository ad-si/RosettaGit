...
The [TIOBE](http://www.tiobe.com/tpci.htm) index, which measures the growth of programming languages, ranks Ruby as #11 among programming languages worldwide.
Much of the growth is attributed to the popularity of software written in Ruby, particularly the Rails web framework.

An interactive tutorial is available in the form of an [Interactive Console](http://tryruby.org/) inside of your Web Browser.
