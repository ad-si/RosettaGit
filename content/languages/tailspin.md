...
[Syntax reference](https://github.com/tobega/tailspin-v0/blob/master/TailspinReference.md)

Development page, also how to run Tailspin programs [on github](https://github.com/tobega/tailspin-v0)
