...
With 4000+ watchers and 300+ forks (as of December 2011), CoffeeScript is ranked as one of the "most interesting" projects on Github. <https://github.com/repositories> The language has a relatively large following in the Ruby community, and has been used in production by [37signals](http://thinkvitamin.com/mobile/new-rails-like-framework-from-37signals-for-html5-mobile-apps/).  Ruby on Rails began to include CoffeeScript  in its asset pipeline in Rails version 3.1 (see <http://www.rubyinside.com/rails-3-1-adopts-coffeescript-jquery-sass-and-controversy-4669.html>).
...
## Citations
# Github. "[Interesting Repositories](https://github.com/repositories)", Github, Nov 10, 2010.
# Carson, Ryan. "[New Rails-like Framework from 37signals for HTML5 Mobile Apps](http://thinkvitamin.com/mobile/new-rails-like-framework-from-37signals-for-html5-mobile-apps/)", Think Vitamin blog, Nov 8, 2010.
# Hagenburger, Nico. "[Rails 3.1 – A Sneak Preview](http://www.hagenburger.net/TALKS/rails-3.1-frontend-performance.html)", presentation for [Railscamp Hamburg](http://railscamp-hamburg.de/) on Oct 23, 2010.
# Ashkenas, Jeremy. "[The Plan for 1.0](https://github.com/jashkenas/coffee-script/issues/830)", Github issue tracker, Nov 4, 2010.

## External links
* [GitHub repository](https://github.com/jashkenas/coffee-script/)
* [@CoffeeScript](http://twitter.com/coffeescript) - Twitter feed
