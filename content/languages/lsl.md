...
# Second Life's own [LSL Portal](https://wiki.secondlife.com/wiki/LSL_Portal)
# a user supported [LSL Wiki](http://lslwiki.net/lslwiki/wakka.php)

## Libraries
There exists several open source libraries where users share code
* [LSL Scripting Library](http://community.secondlife.com/t5/LSL-Scripting-Library/bd-p/LSLScriptingLibrary)
* [LSL Examples](https://wiki.secondlife.com/wiki/Category:LSL_Examples)
* [Free LSL Scripts](http://www.free-lsl-scripts.com/cgi/freescripts.plx)
* [LSL Scripting](http://community.secondlife.com/t5/LSL-Scripting/bd-p/LSLScripting)

## External Editors
There are also many [external editors](https://wiki.secondlife.com/wiki/LSL_Alternate_Editors) for LSL allowing you to write, syntax check, and (to a limited extent) execute LSL outside of the Second Life environment.  You will need to sign up at [Second Life](http://secondlife.com) and have a Second Life account to execute LSL in the virtual world.  Your scripts can exist by themselves in a folder of your inventory, or in an Object in your inventory, but need to be in an Object that is in-world to execute (if an Object containing scripts is taken in to your inventory, the scripts will be suspended and will resume when brought out in to the world again.)
