...
** [Locomotive BASIC command reference with code examples](http://www.grimware.org/doku.php/documentations/software/locomotive.basic/) (based on the official documentation)
