...
* [OpenBSD bc(1) manual page](https://www.openbsd.org/cgi-bin/man.cgi?query=bc&apropos=0&sektion=1&manpath=OpenBSD+Current&arch=i386&format=html)
* [src/usr.bin/bc/](https://www.openbsd.org/cgi-bin/cvsweb/src/usr.bin/bc/)
