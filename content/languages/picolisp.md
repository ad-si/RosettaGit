...
To try the RosettaCode tasks, download [picoLisp.tgz](https://software-lab.de/picoLisp.tgz), unpack it, and follow the instructions in README and INSTALL. Unless stated otherwise, the examples assume that the interpreter was started with the command
```bash
$ pil +
:
```
...
## See Also
* [Reference Manual](https://software-lab.de/doc/ref.html)
* [Frequently asked questions](https://software-lab.de/doc/faq.html)
