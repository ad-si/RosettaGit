...
From the [Visual Basic Developer Center](https://msdn.microsoft.com/en-us/vbasic/) website: "With Visual Basic, you can create applications for Windows, the Web, mobile devices, and Office on the .NET Framework". Visual Basic .NET makes it easy to create [Windows](https://rosettacode.org/wiki/Windows) form applications quickly and efficiently. The language is [object-oriented](https://rosettacode.org/wiki/object-oriented) and has unique features to speed development and deployment.
...
* [The Visual Basic Developer Center](https://msdn.microsoft.com/en-us/vbasic/)
