...
tags = []
+++
Red is a paradigm-neutral [homoiconic](http://en.wikipedia.org/wiki/Homoiconicity) language, strongly inspired by [Rebol](https://rosettacode.org/wiki/Rebol).
...
* [Mailing-List](http://groups.google.com/group/red-lang?hl=en)
