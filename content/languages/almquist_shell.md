...
* [FreeBSD /bin/sh](http://svnweb.freebsd.org/base/head/bin/sh/)
* [NetBSD /bin/sh](http://cvsweb.netbsd.org/bsdweb.cgi/src/bin/sh/?only_with_tag=MAIN)
...
* [Ash (Almquist Shell) Variants](http://www.in-ulm.de/~mascheck/various/ash/), a history of many Ash versions and their features
