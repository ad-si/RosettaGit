...
It is described on [GitHub](https://github.com/satyr/coco) (where all the documentation currently resides) as being designed according to the following principles:
