...
It implements an extended subset of [R<sup>5</sup>RS](http://www.schemers.org/Documents/Standards/R5RS/) ([R<sup>7</sup>RS](http://www.r7rs.org) from version 2.0) Scheme including, but not limited to, some of the [SRFI](https://srfi.schemers.org/)s, open source / free software, with a permissive license.
...
Builds and source codes can be found at project [home page](https://yuriy-chumak.github.io/ol/) or [Github](https://github.com/yuriy-chumak/ol).
