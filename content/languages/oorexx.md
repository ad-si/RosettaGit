...
open sourced, maintained by the [Rexx Language Association](https://www.rexxla.org/).

ooRexx can be used to run many programs shown here in the [REXX](https://rosettacode.org/wiki/REXX) category.

See <https://rosettacode.org/wiki/Rosetta_Code:Village_Pump/Dialects#REXX.2C_ooRexx.2C_and_others>
for differences.
