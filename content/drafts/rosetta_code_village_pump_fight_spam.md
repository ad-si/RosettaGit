...
::I didn't want to block the IPs because we had previously had a problem with an IP collision with a legitimate user. I'm not really sure what else I can do. We do have a [CAPTCHA](http://www.mediawiki.org/wiki/Extension:ConfirmEdit), but maybe it's not good enough. --[[User:Mwn3d|Mwn3d]] 13:57, 29 June 2009 (UTC)
