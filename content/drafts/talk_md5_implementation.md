...
* The Python examples use hashlib which uses an external call.  However, there is Python 2 code <https://www.equi4.com/md5/> that is native and a direct translation of RFC 1321 with the RSA copyrights (I think a derivative work of an RFC is fair game but haven't actually checked it out).
