...
:::: If the task is to ["display a table"](https://rosettacode.org/mw/index.php?title=Create_an_HTML_table&oldid=103045), then my [[Ruby]] code is wrong, because it only outputs the HTML for a table, and never displays the table. Perhaps we should delete the Ruby example, and the other examples that never display a table? --[[User:Kernigh|Kernigh]] 02:18, 11 March 2011 (UTC)
