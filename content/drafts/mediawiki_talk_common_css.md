...
:Only anonymous users will see ads.  See [[Rosetta_Code:Village_Pump/Ideas_for_2010#advertisements.3F|advertisements in 2010]] and the comment on [this diff](https://rosettacode.org/mw/index.php?title=MediaWiki:Common.css&curid=4&diff=71369&oldid=22099).
...
:: Try <code>overflow: auto;</code>. In Firefox, this creates scroll bars only as necessary (I tried it out with Firebug, and it works great). [The standard](https://www.w3.org/TR/CSS21/visufx.html#propdef-overflow) is vague as to exactly what should happen, but my guess is that most browsers will do what you want. —[[User:Underscore|Underscore]] ([[User talk:Underscore|Talk]]) 15:32, 26 January 2010 (UTC)
