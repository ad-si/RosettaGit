...
:The origional task description did not mention the IPF and called for 25 lines of the triangle. The purpose of G(n) is to show that you can generate the nth line of this triangle without having to display all 12345 elements of it. Other formulations are interesting but not solutions to this task. I have added a child task <https://rosettacode.org/wiki/9_billion_names_of_God_the_integer/Worship_of_false_idols> where I think that these related triangles should be discussed.--[[User:Nigel Galloway|Nigel Galloway]] ([[User talk:Nigel Galloway|talk]]) 13:12, 3 May 2013 (UTC)
:Note that <https://rosettacode.org/wiki/9_billion_names_of_God_the_integer#Full_Solution> does exactly that which you say no example does.--[[User:Nigel Galloway|Nigel Galloway]] ([[User talk:Nigel Galloway|talk]]) 13:12, 3 May 2013 (UTC)
...
:::See <https://rosettacode.org/wiki/Talk:9_billion_names_of_God_the_integer#The_One_True_Triangle.2C_Three_Triangles_in_One_Eternal_Trinity> for a full explanation.--[[User:Nigel Galloway|Nigel Galloway]] ([[User talk:Nigel Galloway|talk]]) 12:26, 4 May 2013 (UTC)
...
:The vertical edge of the green triangle is ina1 in [Ruby Full Solution](https://rosettacode.org/wiki/9_billion_names_of_God_the_integer#Full_Solution) and is the horizontal edge of the grey triangle.
:The horizontal edge of the green triangle is ina2 in [Ruby Full Solution](https://rosettacode.org/wiki/9_billion_names_of_God_the_integer#Full_Solution).
