...
:The vertical edge of the green triangle is ina1 in [Ruby Full Solution](http://rosettacode.org/wiki/9_billion_names_of_God_the_integer#Full_Solution) and is the horizontal edge of the grey triangle.
:The horizontal edge of the green triangle is ina2 in [Ruby Full Solution](http://rosettacode.org/wiki/9_billion_names_of_God_the_integer#Full_Solution).
