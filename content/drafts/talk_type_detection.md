+++
title = "Talk:Type detection"
description = ""
date = 2017-11-07T14:04:35Z
aliases = []
[extra]
id = 19627
[taxonomies]
...
:# '''Thoughts:''' The message of Rosetta is that you get deep insights when different languages are coming at the same non-linguistic task from their own distinctive angles, rather than each trying to jump through contrived grammatical or notational hoops. There may well be interesting and genuine problems to which solutions can be found by making use of the notion of type, but I think the way to find them will be to step back from particular (and perhaps parochial)  problems encountered within scripting (and other dynamically typed) languages, and to think a bit more deeply about what type systems are good for, and why they are there.
...
::#Likely to harvest responses from '''as many different languages as possible'''
...
==Delete?==
I am thinking of deleting this task after 09-Oct-2015 due to the lack of credibility of the creator account. --[[User:Paddy3118|Paddy3118]] ([[User talk:Paddy3118|talk]]) 15:08, 8 October 2015 (UTC)
