...
::::: Gerard, you may wish to look at [Knapsack_problem](http://rosettacode.org/wiki/Knapsack_problem). The four tasks on this page are children of [Knapsack_problem](http://rosettacode.org/wiki/Knapsack_problem). To do this you enter "Knapsack problem/Bounded" in the create page dialog. Similarly [Mathprog solution](http://rosettacode.org/wiki/Knapsack_problem/Bounded/Mathprog) is a child of [Knapsack_problem/Bounded](http://rosettacode.org/wiki/Knapsack_problem/Bounded) and was created by entering "Knapsack_problem/Bounded/Mathprog" in the create page dialog.--[[User:Nigel Galloway|Nigel Galloway]] 12:32, 2 February 2013 (UTC)
