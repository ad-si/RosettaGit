...
The task description contains a broken link to the word list 'unixdict.txt'.  Perhaps the link could be changed to a working link for the original file that can be found at the internet archive, 'The Wayback Machine', [unixdict.txt](https://web.archive.org/web/20160419090505/https://www.puzzlers.org/pub/wordlists/unixdict.txt). --[[User:Demivec|Demivec]] ([[User talk:Demivec|talk]]) 08:05, 18 January 2019 (UTC)
