...
Ah, I get it. You just forgot to add it to the table in the task descrition [here](https://rosettacode.org/mw/index.php?title=Price_Fraction&diff=77456&oldid=77453), and I just looked and saw that the Clipper table had the same entries as the original table and assumed that what was missing was what I then added. (Which in this case just happened to match the Clipper code).
...
:: Two topics on the original wiki, [Floating Point Currency](https://c2.com/cgi/wiki?FloatingPointCurrency) and [Money Object](https://c2.com/cgi/wiki?MoneyObject), contain many anecdotes, cautionary tales, and useful links. For a toy problem like this, using an integer in units of cents should suffice. --[[User:IanOsgood|IanOsgood]] 01:29, 16 March 2010 (UTC)
