...
:: Perhaps apropos is this quote from Charles Moore's 1970 book "PROGRAMMING A PROBLEM-ORIENTED-LANGUAGE" [Moreover this attitude is reinforced by the massive trend to high-level languages and a placid acceptance of their inefficiencies: What's the use of designing a really good algorithm if the compiler's going to botch it up anyway?](http://www.colorforth.com/POL.htm) --[[User:Rdm|Rdm]] ([[User talk:Rdm|talk]]) 16:23, 28 April 2015 (UTC)
