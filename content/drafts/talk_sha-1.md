...
: What kind of warning is appropriate for SHA-1? [Factor's documentation](https://docs.factorcode.org/) for [SHA](https://docs.factorcode.org/content/article-checksums.sha.html) says, "SHA-1 is considered insecure, while SHA-2 It is generally considered to be pretty strong." OpenBSD [sha(1)](https://www.openbsd.org/cgi-bin/man.cgi?query=sha1&apropos=0&sektion=1&manpath=OpenBSD+5.0&arch=i386&format=html) gives no warning at all, though OpenBSD [md5(1)](https://www.openbsd.org/cgi-bin/man.cgi?query=md5&apropos=0&sektion=1&manpath=OpenBSD+5.0&arch=i386&format=html) gives a warning and recommends sha256. --[[User:Kernigh|Kernigh]] 19:23, 19 January 2012 (UTC)
