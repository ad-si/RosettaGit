...
==Extra Credit?==
Does any example go for the extra credit Unicode combining characters? It seems to have been introduced [here](https://rosettacode.org/mw/index.php?title=Reversing_a_string&oldid=22893) by Kevin Reid, but I am not sure that even his [E example](https://rosettacode.org/mw/index.php?title=Reversing_a_string&oldid=36231#E) goes for the extra credit. --[[User:Paddy3118|Paddy3118]] 04:35, 28 July 2009 (UTC)
...
# The most relevant parts of [Unicode 6.0.0](https://www.unicode.org/versions/Unicode6.0.0/) seem to be section 3.6 "Combination" and section 3.12 "Conjoining Jamo Behavior".
...
:Have you considered [directionality](https://unicode.org/reports/tr9/)? --[[User:Rdm|Rdm]] 04:13, 31 January 2011 (UTC)
