...
== What is a quine? ==
I did not read up as fully as I should have on this task. The program is to output its own source without accessing files. This makes the examples here incorrect. See [the wiki](http://en.wikipedia.org/wiki/Quine_%28computing%29) for more clarification. --[[User:Mwn3d|Mwn3d]] 20:32, 17 November 2007 (MST)
