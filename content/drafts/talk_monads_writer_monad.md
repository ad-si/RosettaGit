...
:::For that, I guess I'd start from <https://www.jsoftware.com/help/dictionary/contents.htm> - there's tutorial information starting from the left, and reference information on the right. And of course, focus on the parts which mention grammatical issues. Or, if that's too dense for your taste, you might be able to find something more to your liking under <https://www.jsoftware.com/books/>. The "J for C Programmers" pdf, for example, trys to aim at an audience with a traditional programming background. --[[User:Rdm|Rdm]] ([[User talk:Rdm|talk]]) 23:31, 3 February 2016 (UTC)
