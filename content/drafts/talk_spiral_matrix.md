...
See [Spiral](https://paddy3118.blogspot.com/2008/08/spiral.html). --[[User:Paddy3118|Paddy3118]] 06:30, 5 August 2008 (UTC)
...
Nothing about this list pops out at me, but if you read the [original article](https://www.jsoftware.com/papers/play132.htm), you'll see a smart J guy (Joey Tuttle) noticed that this list looks like the ''grade'' of another list.
...
Generating the underlying pattern (<tt>ones_and_fives</tt>) is left as an exercise for the reader.  But, if you get stuck, it's spelled out in [the original article](https://www.jsoftware.com/papers/play132.htm).
...
For a fuller explanation, see [the original source](https://www.jsoftware.com/papers/play132.htm).
...
Hi Spoon, your edit to Spiral of substituting <python>array = [[None]*n]*n</python> for <python>array = [[None]*n for j in range(n)]</python> [here](https://www.rosettacode.org/w/index.php?title=Spiral&curid=2967&diff=16906&oldid=16746) doesn't work because of: 
