...
:: You can find a list of changes between releases in the [CHANGELOG](http://geshi.svn.sourceforge.net/svnroot/geshi/trunk/geshi-1.0.X/src/docs/CHANGES). That also lists added languages. --[[User:BenBE|BenBE]] 23:38, 20 February 2010 (UTC)
