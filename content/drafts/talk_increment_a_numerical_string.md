...
I removed <tt>int2str</tt> in [a recent revision](https://rosettacode.org/mw/index.php?title=Increment_a_numerical_string&diff=83245&oldid=81783) because of "various bugs". For the record the issues I noticed are:
