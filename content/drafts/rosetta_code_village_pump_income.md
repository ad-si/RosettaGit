...
::I just did some looking, but I don't see any immediately-obvious "request funding"-type links (for a good reason, I suppose). The Foundation has a [Board of Trustees](http://wikimediafoundation.org/wiki/Board_of_Trustees) which includes a [Treasurer](http://wikimediafoundation.org/wiki/Treasurer): [[wp:User:Stu|Stu West]]. It might be worth it to harass him; his email is listed on his wp userpage.
::I ''did'' find [this thing](http://wikimediafoundation.org/wiki/File:WMF_Partnerships_TEMPLATE_Grant_Application_Support_Letter.odt), but it's an "orphan" over there ("There are no pages that link to this file").
::I also found a (former?) office called [Grants Coordinator](http://wikimediafoundation.org/wiki/Grants_Coordinator), but it looks like it's been vacant for 4 years. -- [[User:Eriksiers|Erik Siers]] 07:15, 3 March 2011 (UTC)
...
::: I can see how some of Semantic MediaWiki's features might lend themselves in that direction, but nothing that's part of MW inherently. BTW, this did spawn some discussion in the IRC channel: [https://irclog.perlgeek.de/rosettacode/2011-03-03#i_3353924](https://irclog.perlgeek.de/rosettacode/2011-03-03#i_3353924). --[[User:Short Circuit|Michael Mol]] 19:24, 3 March 2011 (UTC)
