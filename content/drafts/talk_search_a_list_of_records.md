...
Please see [[Rosetta_Code:Add_a_Task|Add a Task]] and if you are more generally interested, check out the "Ways to Contribute" column on the [home page](https://rosettacode.org). --[[User:Rdm|Rdm]] ([[User talk:Rdm|talk]]) 04:49, 10 October 2015 (UTC)
...
::: But on second thoughts, do we need this task anyway, given the existing <https://rosettacode.org/wiki/Search_a_list> ? [[User:Hout|Hout]] ([[User talk:Hout|talk]]) 14:43, 10 October 2015 (UTC)
