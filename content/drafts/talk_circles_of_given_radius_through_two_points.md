...
:Walter, the XPL0 was actually never ''removed'': [this edit](https://rosettacode.org/mw/index.php?title=Circles_of_given_radius_through_two_points&diff=209250&oldid=208439) adding the entry on Visual FoxPro mistakenly ended with a ''pre'' HTML tag, which made the XPL0 entry show up at the end of the VisualFox Pro entry. I'll remove it now. [[User:Eoraptor|Eoraptor]] ([[User talk:Eoraptor|talk]]) 20:17, 28 December 2017 (UTC)
