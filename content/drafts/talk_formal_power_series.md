...
::::::It is not sloppy. <math>\int f</math> is an [indefinite integral](http://en.wikipedia.org/wiki/Indefinite_integral) of ''f''. <math>\int\int f</math> is defined up to a linear function, of course. So <math>cos = -\int\int cos</math> is perfectly OK.
