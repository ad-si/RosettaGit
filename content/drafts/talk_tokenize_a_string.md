...
Calling tr a programming language would leave you out on a limb w.r.t. tr's documentation and articles about tr on the web such as [tr](http://www.linfo.org/tr.html), and [GNU tr](http://www.gnu.org/software/coreutils/manual/html_node/tr-invocation.html#tr-invocation).
