...
:Yep, The New York Times seems to have got the ''exact'' details of the competition  wrong. I was wondering why my maxima were under 0.55 so quickly when the NYT mentions n>2**31. See [here](http://www.jstor.org/stable/2324028), which agrees with [this](http://mathworld.wolfram.com/Hofstadter-Conway10000-DollarSequence.html). Does the draft status of the task allow me to change its goals with impunity ;-)

:--[[User:Paddy3118|Paddy3118]] 05:48, 10 March 2010 (UTC)

==Mallows' Number==

According to [Mathworld](http://mathworld.wolfram.com/Hofstadter-Conway10000-DollarSequence.html), the correct number is 1489, yet some of the entries are giving different results. Shouldn't they be marked as incorrect?
