...
==Clarify the task==
It is not clear to me if the task is asking for a function which compares two floating point values to be within a given tolerance or looking at languages implementation of floating point values. If the latter maybe [does 0.1+0.2=0.3](https://0.30000000000000004.com/) might be a useful ref.--[[User:Nigel Galloway|Nigel Galloway]] ([[User talk:Nigel Galloway|talk]]) 15:40, 3 September 2019 (UTC)
