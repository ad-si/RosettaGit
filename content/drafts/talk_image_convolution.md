...
There is an article about [convolution](https://en.wikipedia.org/wiki/Convolution) but it does not talk at all about how to apply it on image processing. In the French area it is in this article:
...
but when I grep in the [English equivalent](https://en.wikipedia.org/wiki/Image_processing) I find nothing. Nothing too in the article [linear filter](https://en.wikipedia.org/wiki/Linear_filter) even if the word convolution appears, but without details.<BR>
...
* [Additive CA](https://mathworld.wolfram.com/AdditiveCellularAutomaton.html); this page tells about the link between convolution explained into Wikipedia and its CA-related analog
