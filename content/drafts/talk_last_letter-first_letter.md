...
==Timings==
Could the timings on the D examples be removed or changed to just a statement of their relative run times under similar conditions, as we don't compare language run times on this site as it is [too difficult a task to get right](http://shootout.alioth.debian.org/dont-jump-to-conclusions.php). If a language has only one timing then I guess it should be removed altogether? Thanks. --[[User:Paddy3118|Paddy3118]] 18:36, 28 June 2011 (UTC)
