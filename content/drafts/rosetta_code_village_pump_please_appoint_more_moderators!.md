...
:::::: It looks like there is an extension available which does what you want: [Extension:Nuke](https://www.mediawiki.org/wiki/Extension:Nuke). And it should be [bundled with our current wiki version](https://www.mediawiki.org/wiki/MediaWiki_1.26#Bundled_extensions). So Mike would need to enable it.
:::::: In my experience using a blocklist works pretty well. On the [Zsh Wiki](http://zshwiki.org/home) there was a long-time spammer who always posted the same links on several pages. After suggesting to the admin that he should add some of the links to a blocklist the spammer quickly gave up.
