...
The double sum formula used by the REXX example is #33 from the entry [Bernoulli number](https://mathworld.wolfram.com/BernoulliNumber.html) on The Eric Weisstein's World of Mathematics (TM).
