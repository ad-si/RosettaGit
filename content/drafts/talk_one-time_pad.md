...
:On Windows, e.g. there is the [CryptGenRandom_function](https://msdn.microsoft.com/en-us/library/windows/desktop/aa379942%28v=vs.85%29.aspx), which MS claims "fills a buffer with cryptographically random bytes". --[[User:Hajo|Hajo]] ([[User talk:Hajo|talk]]) 12:45, 13 December 2014 (UTC)
