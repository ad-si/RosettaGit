...
Of possible interest:  <https://oeis.org/A096427> &mdash;[[User:Sonia|Sonia]] 20:48, 9 February 2012 (UTC)

==On Using The Arithmetric Geometric Mean to Calculate Pi==
I have included examples of using the agm to calculate Pi:

: <https://rosettacode.org/wiki/Pi#C.2B.2B>
: <https://rosettacode.org/wiki/Pi#using_agm>
