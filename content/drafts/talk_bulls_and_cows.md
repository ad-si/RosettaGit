...
The description says that the digits must be from the set 1 through 9, but [Wikipedia](https://en.wikipedia.org/wiki/Bulls_and_cows) - and some of the solutions on this page - allow zeroes.  Also, the description should probably specify whether or not repeated digits are allowed.
