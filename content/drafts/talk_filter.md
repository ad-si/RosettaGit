...
: Is anyone able to test the Objective-C code on a "real" Cocoa Mac OS X framework? I believe it won't work. I have not found any reason why it should work reading into the Apple doc, like [here](http://developer.apple.com/DOCUMENTATION/Cocoa/Conceptual/Predicates/Articles/pBNF.html) and related. The modulus:by: selector is understood by NSExpression, but nothing in NSPredicate let me think that selector is "passed" to a NSExpression object... --[[User:ShinTakezou|ShinTakezou]] 23:01, 17 March 2009 (UTC)
