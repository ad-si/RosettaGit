...
I am considering deletng that example. RC is not the place to pursue private vendettas againt Python's percieved lack of support for a pet programming style in its guidelines. ([Ref](http://rosettacode.org/wiki/Talk:Cheryl%27s_Birthday)).
...
:: Hi Nigel; according to the page history [You have "denigrated" your own example](http://rosettacode.org/mw/index.php?title=McNuggets_Problem&type=revision&diff=271712&oldid=271667)! Please check. [[User:Paddy3118|Paddy3118]] ([[User talk:Paddy3118|talk]]) 14:48, 29 October 2018 (UTC)
