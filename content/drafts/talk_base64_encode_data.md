...
```txt
urllib2.urlopen('https://rosettacode.org/favicon.ico')
```

, it gives a 403 error. And if I do

```txt
print urllib.urlopen('https://rosettacode.org/favicon.ico').read()
```
