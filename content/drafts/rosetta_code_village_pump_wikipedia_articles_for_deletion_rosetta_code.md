...
One thing I gained from the conversations as [[wp:Wikipedia:Articles_for_deletion/Rosetta_Code]] was the urge to do a [google scholarly search](http://scholar.google.com/scholar?q=RosettaCode.org)  for RC and found RossettaCode.org specifically mentioned in:
...
* "Linking Documentation and Source Code in a Software Chrestomathy - JM Favre, R Lämmel, M Leinberger, T Schmorleiz… - [University of Koblrenz](http://softlang.uni-koblenz.de)".
