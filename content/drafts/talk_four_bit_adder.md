...
Could someone move the C++ code to a separate sub-page at least? That huge wad of code is over 16 pages long where the others are less than two pages! It is clearly [anomalous](http://oxforddictionaries.com/definition/anomalous) in size.
