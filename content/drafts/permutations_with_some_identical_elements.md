...
{{out|output|text=  when using the default inputs:     <tt> 2   3   1 </tt>}}
...
{{out|output|text=  when using the inputs of:     <tt> -1   2   1   2   1 </tt>}}
...
{{out|output|text=  when using the inputs of:     <tt> -1   2   3   2   1 </tt>}}
...
{{out|output|text=  when using the inputs of:     <tt> -1   1   5   2 </tt>}}
