...
:I'm a little late with this, I suppose, but I've been dinking around with [Piet](http://www.dangermouse.net/esoteric/piet.html) ([Esolangs entry](http://esolangs.org/wiki/Piet)) over the past few days, and its programs are ''entirely'' images. (From the Piet page: "Piet is a programming language in which programs look like abstract paintings.") I like the language (as a toy), but it's possible (although somewhat unlikely) that the images could get... '''big'''. (Biggest one known ''so far'': [Image:http://www.dangermouse.net/esoteric/piet/pietquest.png])
...
::People have reported the same problem across multiple browsers. I've had it myself on Firefox and IE. I found a [really weird workaround](http://irclog.perlgeek.de/rosettacode/2011-07-06#i_4069398). We're hoping that a MediaWiki update can fix it. --[[User:Mwn3d|Mwn3d]] 13:52, 29 November 2011 (UTC)
...
:I went to [File list](http://rosettacode.org/wiki/Special:ListFiles) and discovered that all file uploads are blocked since 6/2/2016, even admins have no uploads. Is it sort of technical glitch? Or result of fighting spam too hard?? I'm planning 3 new tasks with 7 pictures. Without picture uploads it is useless. Now this is an old Q (late June): Another interesting issue: Why nobody complains? --AnatolV 19:34, 21 July 2016 (UTC)
