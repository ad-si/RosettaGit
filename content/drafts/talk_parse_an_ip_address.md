...
:::::: So the "In languages where variant result types are clumsy" bit is about how an example represents data internally, then. I think I understand, then. Not certain it's necessary, though. In answer to your question, the address would probably be represented using something like a [sockaddr](http://msdn.microsoft.com/en-us/library/windows/desktop/ms737530(v=VS.85).aspx) structure.--[[User:Short Circuit|Michael Mol]] 16:48, 28 September 2011 (UTC)
