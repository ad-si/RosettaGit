...
How about direction associated with the $ instruction?  Split creates a new thread in reversed direction.  Discovered by reading [a befunge interpreter](https://github.com/cybojanek/befunge/blob/master/befunge/BefungeProgram.py).  Thanks.
