...
So what happens when someone creates a RC page for a language that isn't listed on HOPL? For example I could imagine starting a page about [itcl](https://wiki.tcl-lang.org/62) (which is to Tcl kinda like C++ is to C) but which isn't listed over there. Just curious...
...
[HOPL: History_of_Programming_Languages](https://en.wikipedia.org/wiki/History_of_Programming_Languages)
