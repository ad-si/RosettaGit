...
::BTW wheels can be generated, without using any trial divisions, too (e.g. [this](http://www.haskell.org/haskellwiki/Prime_numbers#Wheeled_list_representation)). -- [[User:WillNess|WillNess]] ([[User talk:WillNess|talk]]) 21:18, 10 September 2014 (UTC)
...
:::::::::: Elibarzilay: (sorry, missed your remark before): the big conceptual difference is that it's using the [tree-like folding](http://en.wikipedia.org/wiki/Fold_%28higher-order_function%29#Linear_vs._tree-like_folds) function [''foldi''](http://en.wikipedia.org/wiki/Fold_(higher-order_function)#Tree-like_folds) instead of the linear folding of ''foldr'', for the logarithmic complexity advantage. M.O'Neill derives Bird sieve's complexity at above n^1.5 (in ''n'' primes produced) but the tree folding code runs empirically at the same orders of growth (~ n^1.2..1.25) as her PQ-based code, which is probably ''n (log n)^2 log(log n)''. Earliest such code that I know of is [Jul 16 2007 post by Dave Bayer](https://www.haskell.org/pipermail/haskell-cafe/2007-July/029077.html). -- [[User:WillNess|WillNess]] ([[User talk:WillNess|talk]]) 21:46, 10 November 2014 (UTC)
...
why I made [this edit](http://rosettacode.org/mw/index.php?title=Sieve_of_Eratosthenes&diff=201761&oldid=201693):
