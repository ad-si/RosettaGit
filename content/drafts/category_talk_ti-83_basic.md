...
I'm conflicted about [this edit](https://rosettacode.org/mw/index.php?title=Category:TI-83_BASIC&diff=prev&oldid=84585). A mention of its relationship with [[TI-85 BASIC]] seems useful, but talking about the "chief complaint" of its lacking function calls seems out of place, but suggests that putting each language's omitted task category as a subcat might be useful. The references to [[C]] and [[C++]] seem completely out of place. I don't want to fall into the trap of "citation needed" or forcing a neutral point of view, but the edit seems malicious towards the language. How can something like this be best addressed? --[[User:Short Circuit|Michael Mol]] 22:42, 25 June 2010 (UTC)
