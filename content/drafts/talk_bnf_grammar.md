...
::::Some of these may be available on language websites (for instance, Java's entire grammar is available [here](https://docs.oracle.com/docs/books/jls/third_edition/html/j3TOC.html) with explanations). Would it be ok to just link to them from here? That'll automatically give credit to whoever they want. --[[User:Mwn3d|Mwn3d]] 18:22, 23 June 2009 (UTC)
...
FWIW, the portion of the language that can be described in a context-free way is the language basic parser, as documented in [Tcl(n)](https://www.tcl-lang.org/man/tcl8.6/TclCmd/Tcl.htm), but that is only one very small part of the whole. To write a BNF in for this “task” would be a sham. —[[User:Dkf|Donal Fellows]] 22:39, 21 June 2009 (UTC)
