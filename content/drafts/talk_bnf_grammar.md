...
FWIW, the portion of the language that can be described in a context-free way is the language basic parser, as documented in [Tcl(n)](http://www.tcl.tk/man/tcl8.6/TclCmd/Tcl.htm), but that is only one very small part of the whole. To write a BNF in for this “task” would be a sham. —[[User:Dkf|Donal Fellows]] 22:39, 21 June 2009 (UTC)
