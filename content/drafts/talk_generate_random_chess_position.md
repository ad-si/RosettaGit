...
:To clarify: yes, putting a white pawn on the first rank or a black pawn on the eighth rank is allowed, even if it's impossible in a normal chess game.  The reason is that on [lichess](http://en.lichess.org) sometimes players challenge each other on custom starting positions and it's not rare that they chose to place pawns there.--[[User:Grondilu|Grondilu]] ([[User talk:Grondilu|talk]]) 11:42, 14 December 2015 (UTC)
