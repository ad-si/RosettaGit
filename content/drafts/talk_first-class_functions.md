...
:: AutoHotkey doesn't really support eval natively either. I just made a generic "compose" function, called map. It is overloaded to create a composition, and then funcall those compositions. AutoHotkey internal data structures include functions are documented in [LowLevel](https://www.autohotkey.com/forum/topic26300.html) and can be created and manipulated as any other data.  I think to do this in C, you just have to manipulate its internal data structures, which is machine code.  See [[wp:Self-modifying_code]], Dynamic Machine Code Generation in [v8 javascript](https://code.google.com/apis/v8/design.html) and AutoHotkey machine code functions [script](https://www.autohotkey.com/forum/topic21172.html) --[[User:Tinku99|Tinku99]] 18:48, 5 June 2009 (UTC)
==Task Name==
...
Hello, I changed the Javascript example (<https://rosettacode.org/mw/index.php?title=First-class_functions&diff=97198&oldid=97008> ) because I think the old one is totally bogus - no semicolons, no "function" keyword, local var "fn" unintentionally overrides the "fn" array; doesn't work anywhere I tried (Firefox and jsdb). Is this perhaps some dialect I don't know of? UPD hmmm, just found out that jsdb uses the same Javascript engine as Firefox, namely SpiderMonkey... but anyway, my point stands:)[[Special:Contributions/92.226.26.38|92.226.26.38]] 16:28, 12 December 2010 (UTC)
...
::I'll keep them, I think it's much cleaner this way. And it seems omittting semicolons [isn't](http://codeidol.com/javascript/learning-javascript/Operators-and-Statements/Format-of-a-JavaScript-Statement/) practical except for but the simplest statements (like "x=3")[[Special:Contributions/92.226.26.38|92.226.26.38]] 16:52, 12 December 2010 (UTC)
...
:::::With the widespread availability of [W^X](https://en.wikipedia.org/wiki/W%5EX), this dirty hack is not going to work on (m)any platform. [[User:Eoraptor|Eoraptor]] ([[User talk:Eoraptor|talk]]) 23:54, 17 February 2019 (UTC)
