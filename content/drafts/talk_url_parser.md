...
Yes, [appendix A of rfc 3986](https://tools.ietf.org/html/rfc3986#appendix-A) defines a different syntax than the simplified statement at the beginning of this task. This is a flaw in this task's description, and someone should replace the incorrect statements in the task description with a rendition of that appendix A (and after that any task implementations which don't do it right should be fixed, or marked as incorrect). --[[User:Rdm|Rdm]] ([[User talk:Rdm|talk]]) 13:20, 22 July 2016 (UTC)
