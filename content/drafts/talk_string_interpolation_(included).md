...
* <https://en.wikipedia.org/wiki/String_literal#Variable_interpolation>  reference page is not the main article
* <https://en.wikipedia.org/wiki/Variable_interpolation>  main article
The talk pages already cover some of this.
* <https://en.wikipedia.org/wiki/Talk:String_literal#Variable_interpolation> 
* <https://en.wikipedia.org/wiki/Talk:Variable#interpolation:_rv_example> 
* <https://en.wikipedia.org/wiki/Talk:Variable_%28programming%29>  (the first jump with little on it of relevance) 
