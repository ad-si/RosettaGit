+++
title = "Execute Brainfuck/AutoHotkey"
description = ""
...
;---------------------------------------------------------------------------
    ...
    ; Brainfuck Code
    Gui, Add, GroupBox, w462 h248, Brainfuck Code
...
;---------------------------------------------------------------------------
Interpreter: ; This is the Brainfuck Interpreter
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------
    Progress, b2 w150 zh0 fs9, Brainfuck Interpreter waits for input ...
    Input, InKey$, L1
    Progress, Off
    Return, Asc(InKey$)
}
