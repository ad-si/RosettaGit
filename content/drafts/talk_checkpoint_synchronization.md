...
Is 'checkpoint synchronization' the best name for this task? On wikipedia, there's an article ( <https://en.wikipedia.org/wiki/Barrier_(computer_science)#Threads_synchronization_primitive> ) which seems to fit the description of this task.
