...
* ''Algol68G'' r1.18 is now available for download for RHEL and Fedora-11 from Sourceforge - [Download now](https://sourceforge.net/projects/algol68/).
[[a68toc]] is a compiler that runs on Linux and comes with a 610-page book which teaches the language from scratch.
* ''Algol68toC'' development system is now available from [Debian package only](http://www.poenikatu.co.uk/src/)
