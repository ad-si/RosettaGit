...
I'm trying to make bot that automagically applys [[Code Tag Fixer]] in all Tasks using Mediawiki API (<https://www.rosettacode.org/w/api.php>), but Mediawiki API "action=edit" is disabled, so i can't edit pages automagically with Mediawiki API, making a bot impossible.
