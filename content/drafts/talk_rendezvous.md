...
:::Anyway, I'm revisiting this because I just wanted to note (possibly for myself in the future, possibly for someone else) that I think [[Go]] could do a very nice implementation of this task. It's <code>[select](https://golang.org/doc/go_spec.html#Select_statements)</code> statement (combined with channels and buffers of course) looks an eminently suitable tool. –[[User:Dkf|Donal Fellows]] 09:59, 16 November 2009 (UTC)
