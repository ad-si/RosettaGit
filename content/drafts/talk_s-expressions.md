...
Common Lisp: ANSI Standard available in the form of the [Common Lisp HyperSpec](https://www.lispworks.com/documentation/HyperSpec/Front/index.htm).  The reader syntax is described in [Syntax](https://www.lispworks.com/documentation/HyperSpec/Body/02_.htm).
:this page describing the [Character Syntax Types](https://www.lispworks.com/documentation/HyperSpec/Body/02_ad.htm) seems most interesting.--[[User:EMBee|eMBee]] 02:07, 20 October 2011 (UTC)
...
this [draft RFC](https://people.csail.mit.edu/rivest/Sexp.txt) makes an attempt at a definition, but it was not accepted for reasons that are unknown.
...
: The task is ok for demonstrating simple parsers, but if you want to use it for real work, maybe you need something more rigorous, say, [the almost RFC](https://people.csail.mit.edu/rivest/Sexp.txt)? --[[User:Ledrug|Ledrug]] 04:54, 19 October 2011 (UTC)
