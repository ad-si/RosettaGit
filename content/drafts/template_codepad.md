...
{{infobox_begin}}[Try](http://codepad.org?lang={{urlencode:{{PAGENAME}}}}) this language on [Codepad](http://codepad.org).{{infobox_end}}<includeonly>[[Category:Codepad languages]]</includeonly><noinclude>
