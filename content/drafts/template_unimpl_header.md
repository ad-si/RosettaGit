...
<includeonly>[[Category:Unimplemented tasks by language|{{{1}}}]]</includeonly>{{#ifeq: {{{1}}} | C |<div class="messagebox">Due to a bug in mod_rewrite, the link for tasks not implemented in C++ may redirect here. To go there, try [this link](https://rosettacode.org/w/index.php?title=Reports:Tasks_not_implemented_in_C%2B%2B) instead.</div>|}}
