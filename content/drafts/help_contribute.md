...
==Removing a page==
To delete a page (in case you make a mistake that can't be corrected by editing), note it in a talk page and/or directly ask a [bureaucrat](https://rosettacode.org/mw/index.php?title=Special:ListUsers&group=bureaucrat) or [administrator](https://rosettacode.org/mw/index.php?title=Special:ListUsers&group=sysop).
