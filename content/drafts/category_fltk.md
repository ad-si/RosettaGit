...
[FLTK](http://www.fltk.org/) (The "Fast, Light Toolkit") is a cross-platform GUI library. Made with 3D graphics programming in mind, it has an interface to [[OpenGL]], but it is still suitable for general GUI programming.
