...
: I think I read that for all starting permutations you either start at or end up with one on top. There was no mention of it not terminating.  There is [a variant](https://oeis.org/A000376) where you only count a perm if it ends up sorted when the one is on top. (It doesn't always). --[[User:Paddy3118|Paddy3118]] 23:28, 23 November 2012 (UTC)
