...
::: When I had finished the Python version I checked it with tables of the first 1000 values refered to from Sloane: [here](https://oeis.org/A005228/b005228.txt) for R and [here](https://oeis.org/A030124/b030124.txt) for S, although the table for S has an off-by-one error. --[[User:Paddy3118|Paddy3118]] 18:31, 22 October 2011 (UTC)
