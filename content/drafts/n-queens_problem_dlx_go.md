+++
title = "N-queens problem/dlx go"
description = ""
date = 2018-07-02T20:31:00Z
aliases = []
[extra]
id = 21894
[taxonomies]
...
[[WP:Algorithm_X|"Algorithm X"]] is the name Donald Knuth used in his paper "Dancing Links"
to refer to "the most obvious trial-and-error approach" for finding all solutions to
the exact cover problem.
This is an implementation of based on that paper.
