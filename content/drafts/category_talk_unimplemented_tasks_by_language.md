...
:::: According to the [page history](http://www.rosettacode.org/w/index.php?title=Tasks_not_implemented_in_C&action=history), the bot does overwrite the "Tasks not implemented in X" page. So I conclude that link wouldn't stay very long. However the included [[Template:Unimpl header]] appears to be unmodified by the bot. With the help of ParserFunctions it should be possible to add the link only for the C page. I'll try that. --[[User:Ce|Ce]] 07:46, 24 April 2009 (UTC)
