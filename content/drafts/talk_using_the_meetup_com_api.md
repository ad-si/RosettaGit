...
[POST 2/event_comment](https://www.meetup.com/meetup_api/docs/2/event_comment/#create)
...
: Note also the comment "Needs permission to post, which is paid." in <https://rosettacode.org/mw/index.php?title=Using_the_Meetup.com_API&diff=next&oldid=195957> 
...
Rdm, the [Javascript Implementation <https://rosettacode.org/wiki/Using_the_Meetup.com_API#JavaScript>] is complete.
