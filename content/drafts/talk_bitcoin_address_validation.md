...
: Not sure if [This](https://en.bitcoin.it/wiki/Technical_background_of_Bitcoin_addresses) is the definitive thing.  On the other hand though, is it really necessary to have a task with such a narrow range of application? --[[User:Ledrug|Ledrug]] 03:39, 28 November 2012 (UTC)
...
: The PHP code, C code, and probably many more of these snippets are incomplete implementations. I have added a warning at the top of the page to indicate this, as this page is linked to from [the bitcoin wiki](https://en.bitcoin.it/wiki/Address#Address_validation). [[User:Kale|Kale]] ([[User talk:Kale|talk]]) 11:19, 12 September 2015 (UTC)
...
It uses another algorithm inside it, that is simpler and popular, the [Base58Check encoding algorithm](https://en.bitcoin.it/wiki/Base58Check_encoding). So, creating it: [[Base58Check encoding]].  
