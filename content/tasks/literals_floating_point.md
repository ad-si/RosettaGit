...
D built-in floating point types include ''float'' (32-bit), ''double'' (64-bit) and ''real'' (machine hardware maximum precision floating point type, 80-bit on x86 machine) and respective complex number types. Here's information for [Floating Literals](http://www.d-programming-language.org/lex.html#floatliteral).
...
This is an excerpt of an ANTLR grammar for python obtained from [here](http://www.antlr.org/grammar/1200715779785/Python.g).
