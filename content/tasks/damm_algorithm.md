...
The   ['''Damm'''   algorithm](https://en.wikipedia.org/wiki/Damm_algorithm) is a checksum algorithm which detects all single digit errors and adjacent transposition errors.
...
In [this](https://wiki.formulae.org/Damm_algorithm) page you can see the solution of this task.
...
{{Out}}See it running in your browser by [ScalaFiddle (JavaScript, non JVM)](https://scalafiddle.io/sf/d25pzoH/0) or by [Scastie (remote JVM)](https://scastie.scala-lang.org/8t9RuipwRHGGoczFXPvT5A).
