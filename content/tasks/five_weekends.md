...
# see https://rosettacode.org/wiki/Five_weekends#UNIX_Shell
...
See also: [unix-shell](https://rosettacode.org/wiki/Five_weekends#UNIX_Shell) and [Calendar](https://rosettacode.org/wiki/Calendar#AWK).
...
[datetime.icn provides julian](https://www.cs.arizona.edu/icon/library/src/procs/datetime.icn)
...
See also: [awk](https://rosettacode.org/wiki/Five_weekends#AWK) and [[Calendar]].
