...
This example parses the [original](https://rosettacode.org/mw/index.php?title=Check_Machin-like_formulas&oldid=146749) equations to form an intermediate representation then does the checks.
