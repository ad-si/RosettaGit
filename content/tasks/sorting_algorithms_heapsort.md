...
Using package [fgl](https://hackage.haskell.org/package/fgl) from HackageDB
...
Original source: <https://seed7.sourceforge.net/algorith/sorting.htm#heapSort>
...
Since Standard ML is a functional language, a [pairing heap](https://en.wikipedia.org/wiki/Pairing_heap) is used instead of a standard binary heap.
