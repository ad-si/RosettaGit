...
The task should utilize a configurable [audio squelch level](https://en.wikipedia.org/wiki/Squelch) calibration parameter that enables the user to set the silence level threshold (enabling low level background hiss or hum to be removed from the leading and trailing edges of the audio file.) 
