...
For a sample implementation of <code>Ratio</code>, see [the Haskell 98 Report](https://www.haskell.org/onlinereport/ratio.html).
...
The {{libheader|Icon Programming Library}} provides [rational](https://www.cs.arizona.edu/icon/library/src/procs/rational.icn) and [gcd in numbers](https://www.cs.arizona.edu/icon/library/src/procs/numbers.icn).  Record definition and usage is shown below:
...
<https://www.rosettacode.org/wiki/M2000_Interpreter_rational_numbers>
...
[Delimited overloading](https://forge.ocamlcore.org/projects/pa-do/) can be used to make the arithmetic expressions more readable:
...
The library [rational.s7i](https://seed7.sourceforge.net/libraries/rational.htm) defines the type
[rational](https://seed7.sourceforge.net/manual/types.htm#rational), which supports the required functionality.
Rational numbers are based on the type [integer](https://seed7.sourceforge.net/manual/types.htm#integer).
For rational numbers, which are based on integers with unlimited precision, use
[bigRational](https://seed7.sourceforge.net/manual/types.htm#bigRational), which is defined
in the library [bigrat.s7i](https://seed7.sourceforge.net/libraries/bigrat.htm).
