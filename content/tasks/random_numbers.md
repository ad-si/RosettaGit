...
This solution uses math/rand package in the standard library.  See also though the subrepository rand package at <https://pkg.go.dev/golang.org/x/exp/rand>, which also has a NormFloat64 and has a rand source with a number of advantages over the one in standard library.
