...
The C Preprocessor is well explained on the [GNU](https://gcc.gnu.org/onlinedocs/cpp/index.html#Top) site. The pragma page is [here](https://gcc.gnu.org/onlinedocs/cpp/Pragmas.html).
