...
;References:
:*   the OEIS entry:   [odd abundant numbers (odd numbers n whose sum of divisors exceeds 2n)](https://oeis.org/A005231).
...
proper_divisors method taken from <https://rosettacode.org/wiki/Proper_divisors#Ruby>
