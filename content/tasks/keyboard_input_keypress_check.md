...
The library [keybd.s7i](https://seed7.sourceforge.net/libraries/keybd.htm) defines
the file [KEYBOARD](https://seed7.sourceforge.net/libraries/keybd.htm#KEYBOARD) and
the function [keypressed](https://seed7.sourceforge.net/libraries/keybd.htm#keypressed%28in_keyboard_file%29),
...
Note that in both cases, if you want to get characters as users actually type them then you have to [put the terminal in raw mode](https://wiki.tcl-lang.org/14693). That's formally independent of the actual reading of a character.
