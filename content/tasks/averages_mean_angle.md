...
{{works with|ALGOL 68G|Any - tested with release [algol68g-2.8.3](https://sourceforge.net/projects/algol68/files/algol68g/algol68g-2.8.3).}}
...
Try to catch very small cos values and set to 0.0 degrees " Error : Not meaningful" as <https://rosettacode.org/wiki/Averages/Mean_angle#Euler_Math_Toolbox> complains.
...
use std::f64;
// the macro is from
// https://stackoverflow.com/questions/30856285/assert-eq-with-floating-
