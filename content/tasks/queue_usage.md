...
A simpler implementation, where you only need 1 queue can be seen here: <https://rosettacode.org/wiki/Queue/Definition#Forth><BR>
And a Forth version using some new features of Forth 2012, dynamic memory allocation and a linked list can be seen here:<BR> <https://rosettacode.org/wiki/Queue/Definition#Linked_list_version>
