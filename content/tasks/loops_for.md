...
The [<tt>jot(1)</tt>](https://www.openbsd.org/cgi-bin/man.cgi?query=jot&apropos=0&sektion=1&manpath=OpenBSD+Current&arch=i386&format=html) command from [[BSD]] can output an appropriate list of numbers.
