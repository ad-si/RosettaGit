...
The highlighting is done with [EM_SETSEL](https://msdn.microsoft.com/en-us/library/bb761661) and Notepad. Rather crude, but it works. Due to the simplistic nature of the parsing loop, the text ends with a space.
