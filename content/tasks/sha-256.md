...
id = 12533
task = """
  Compute the **SHA-256** digest of the string `"Rosetta code"` and
  verify it equals
  `764faf5c61ac315f1497f9dfa542713965b785e5cc2f707d6468d7d1124cdfcf`.
  Use a library or implement the algorithm directly.
"""
[taxonomies]
...
'''[[wp:SHA-256|SHA-256]]''' is the recommended stronger alternative to [[SHA-1]]. See [FIPS PUB 180-4](http://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.180-4.pdf) for implementation details.
...
Source: [SHA-256 @github](https://github.com/jNizM/AutoHotkey_Scripts/tree/master/Functions/Checksums) by jNizM
...
Uses [crypto++](https://www.cryptopp.com/). Compile it with -lcryptopp
...
The solution to this task would be a small modification to [[MD5#Java|MD5]] (replacing "MD5" with "SHA-256" as noted [here](https://docs.oracle.com/javase/7/docs/technotes/guides/security/StandardNames.html#MessageDigest)).
...
{{libheader|sha2}} ([luarocks install sha2](https://code.google.com/p/sha2/))
...
Use the [Cryptography](http://smalltalkhub.com/#!/~Cryptography/Cryptography) library:
