...
tags = []
languages = [
  "a_is_a_compressed_incidence_matrix",
  "ada",
  "after_f_n_iterations_if_the_error_gets_larger_x0_is_an_optional",
  "and_the_flow_from_i_to_j_is_u_i_u_j_a_i_j",
  "b_column_vector_mx1",
  "bbc_basic",
  "c",
  "cases_it_will_work_well_fast_and_accurate",
  "conjugate_gradient_method_to_solve_hx_b_for_compressed_h",
  "cpp",
  "csharp",
  "d",
  "eps_the_algorithm_stops_when_the_error_gets_smaller_then_eps_or",
  "erre",
  "euler_math_toolbox",
  "f_number_of_steps_when_the_method_should_be_restarted",
  "go",
  "h_compressed_matrix_nxm",
  "h_must_be_positive_definite_use_cpxfit_if_it_is_not",
  "haskell",
  "j",
  "java",
  "julia",
  "kotlin",
  "make_the_incidence_matrix_of_a_rectangle_grid_in_compact_form",
  "mathematica",
  "maxima",
  "octave",
  "perl",
  ...
  "python",
  "racket",
  "return_the_potential_u_for_the_nodes_in_a",
  "rexx",
  "see_cpxfit_cg_cgxnormal",
  "see_makeincidence",
  "see_makerectangleincidence",
  "sidef",
  "solve_the_potential_problem_of_resistance_in_a_graph",
  "start_vector",
  "such_that_u_i_1_u_j_1_and_the_flow",
  "tcl",
  "the_accuarcy_can_be_controlled_with_an_additional_parameter",
  "this_functions_uses_the_conjugate_gradient_method",
  "this_is_the_method_of_choice_for_large_sparse_matrices_in_most",
  "to_each_knot_is_equal_to_the_flow_from_the_knot",
  "x0_optional_start_point_mx1",
  "xpl0",
  "yabasic",
  "zkl",
]
