...
::*   the MathWorld entry for   [totient function](https://mathworld.wolfram.com/TotientFunction.html).
::*   the OEIS      entry for   [Euler totient function phi(n)](https://oeis.org/A000010).
<br/>
