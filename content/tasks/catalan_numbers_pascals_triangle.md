...
*   [Catalan's Triangle](https://mathworld.wolfram.com/CatalansTriangle.html) for a Number Triangle that generates Catalan Numbers using only addition.
*   Sequence [A000108](https://oeis.org/A000108) on OEIS has a lot of information on Catalan Numbers.
...
Uses package Pascal from the Pascal triangle solution<https://rosettacode.org/wiki/Pascal%27s_triangle#Ada>
...
Note that sequence [A000108](https://oeis.org/A000108)  on OEIS (referenced in the task description) confirms that the first four Catalan numbers are indeed 1, 1, 2, 5 ...
