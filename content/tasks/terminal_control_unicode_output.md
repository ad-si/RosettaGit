...
--  <https://pubs.opengroup.org/onlinepubs/007908799/xbd/envvar.html>
...
The Seed7 library [console.s7i](https://seed7.sourceforge.net/libraries/console.htm) defines
[STD_CONSOLE](https://seed7.sourceforge.net/libraries/console.htm#STD_CONSOLE), which can used directly,
or be assigned to [OUT](https://seed7.sourceforge.net/libraries/stdio.htm#OUT) (which is the default
