...
This is a modified example taken from the AutoHotkey documentation for the [SysGet](https://www.autohotkey.com/docs/commands/SysGet.htm) command.
Also, the built in variables [A_ScreenHeight](https://www.autohotkey.com/docs/Variables.htm#Screen) and [A_ScreenWidth](https://www.autohotkey.com/docs/Variables.htm#Screen) contain the width and height of the primary monitor, in pixels.
...
On this system, that returns <code>1440 836</code>. Further discussion of related matters, including platform limitations, is on [the Tcler's Wiki](https://wiki.tcl-lang.org/10872).
