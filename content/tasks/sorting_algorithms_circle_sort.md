...
* For more information on Circle sorting, see [Sourceforge](https://sourceforge.net/p/forth-4th/wiki/Circle%20sort/).
...
This one features the newest version of the algorithm on [Sourceforge](https://sourceforge.net/p/forth-4th/wiki/Circle%20sort/).
...
This one uses the optimized version featured at [Sourceforge](https://sourceforge.net/p/forth-4th/wiki/Circle%20sort/).
...
This version of Circle sort was based on the optimized version on [Sourceforge](https://sourceforge.net/p/forth-4th/wiki/Circle%20sort/). It will also show a few asterisks while running, because it will take some time to finish (about two minutes).
