...
Idris provides the "[implicit](http://docs.idris-lang.org/en/latest/tutorial/miscellany.html#implicit-conversions)" keyword which enables the implicit conversion from one type to another.
...
See the section [Tour of Scala about impplicit conversions.](https://docs.scala-lang.org/tour/implicit-conversions.html)
