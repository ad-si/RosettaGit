...
And if we were to insist on leaving out functions, it's not clear that there would be much of anything left of the language to be doing anything with. See also Henry Rich's writeup on [Tacit Programs](https://www.jsoftware.com/docs/help701/jforc/tacit_programs.htm).
